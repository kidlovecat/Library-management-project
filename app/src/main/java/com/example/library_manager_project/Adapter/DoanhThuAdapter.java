...
public class DoanhThuAdapter extends ArrayAdapter<PhieuMuon> {
    private Context context;
    DoanhThuFragment fragment;
    ...
    public DoanhThuAdapter(@NonNull Context context, DoanhThuFragment fragment, ArrayList<PhieuMuon> lists) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.doanh_thu_item,  null);
        }
